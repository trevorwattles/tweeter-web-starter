      ...
      <div className="form-main w-100 m-auto rounded">
        <form>
          ...
          <div className="text-center mb-3">
            <OAuth provider="Google" icon={["fab", "google"]} />
            <OAuth provider="Facebook" icon={["fab", "facebook"]} />
            <OAuth provider="Twitter" icon={["fab", "twitter"]} />
            <OAuth provider="LinkedIn" icon={["fab", "linkedin"]} />
            <OAuth provider="GitHub" icon={["fab", "github"]} />
          </div>
